...
public class BookSearchQueryParserTests
{
    ...
    [InlineData("description:none", BookSearchMissingField.Description)]
    ...
    [InlineData("alternateTitle:none", BookSearchMissingField.AlternateTitle)]
    [InlineData("alternativeTitle:none", BookSearchMissingField.AlternateTitle)]
