...
public class DictionaryControllerTests
{
    ...
    public async Task GenreController_ShouldForwardAllActionsToMediator()
    {
        ...
        mediator.Setup(mock => mock.Send(It.IsAny<CreateGenreCommand>(), It.IsAny<CancellationToken>())).ReturnsAsync(dto);
        mediator.Setup(mock => mock.Send(It.IsAny<GetAllGenresQuery>(), It.IsAny<CancellationToken>())).ReturnsAsync(page);
        mediator.Setup(mock => mock.Send(It.IsAny<GetGenreQuery>(), It.IsAny<CancellationToken>())).ReturnsAsync(dto);
        mediator.Setup(mock => mock.Send(It.IsAny<GetGenreByNameQuery>(), It.IsAny<CancellationToken>())).ReturnsAsync(dto);
        mediator.Setup(mock => mock.Send(It.IsAny<GetGenreDetailsQuery>(), It.IsAny<CancellationToken>())).ReturnsAsync(details);
        mediator.Setup(mock => mock.Send(It.IsAny<GetGenreDetailsByNameQuery>(), It.IsAny<CancellationToken>())).ReturnsAsync(details);
        mediator.Setup(mock => mock.Send(It.IsAny<UpdateGenreCommand>(), It.IsAny<CancellationToken>())).ReturnsAsync(dto);
        var controller = new GenreController(mediator.Object);

        var created = Assert.IsType<CreatedAtActionResult>(await controller.Create(new CreateGenreCommand("Fantasy", null)));
        ...
        Assert.Same(dto, Assert.IsType<OkObjectResult>(await controller.Update(id, new UpdateGenreCommand { Name = "Drama" })).Value);
    ...
    public async Task StatusController_ShouldForwardAllActionsToMediator()
    {
        ...
        var mediator = new Mock<IMediator>();
        mediator.Setup(mock => mock.Send(It.IsAny<CreateStatusCommand>(), It.IsAny<CancellationToken>())).ReturnsAsync(dto);
        mediator.Setup(mock => mock.Send(It.IsAny<GetAllStatusesQuery>(), It.IsAny<CancellationToken>())).ReturnsAsync(page);
        mediator.Setup(mock => mock.Send(It.IsAny<GetStatusQuery>(), It.IsAny<CancellationToken>())).ReturnsAsync(dto);
        mediator.Setup(mock => mock.Send(It.IsAny<GetStatusByNameQuery>(), It.IsAny<CancellationToken>())).ReturnsAsync(dto);
        mediator.Setup(mock => mock.Send(It.IsAny<GetStatusDetailsQuery>(), It.IsAny<CancellationToken>())).ReturnsAsync(details);
        mediator.Setup(mock => mock.Send(It.IsAny<GetStatusDetailsByNameQuery>(), It.IsAny<CancellationToken>())).ReturnsAsync(details);
        mediator.Setup(mock => mock.Send(It.IsAny<UpdateStatusCommand>(), It.IsAny<CancellationToken>())).ReturnsAsync(dto);
        var controller = new StatusController(mediator.Object);

        var created = Assert.IsType<CreatedAtActionResult>(await controller.Create(new CreateStatusCommand("Reading", null)));
        ...
        Assert.Same(dto, Assert.IsType<OkObjectResult>(await controller.Update(id, new UpdateStatusCommand { Name = "Completed" })).Value);
        Assert.IsType<NoContentResult>(await controller.Delete(id));
    ...
    public async Task TypeController_ShouldForwardAllActionsToMediator()
    {
        ...
        var mediator = new Mock<IMediator>();
        mediator.Setup(mock => mock.Send(It.IsAny<CreateTypeCommand>(), It.IsAny<CancellationToken>())).ReturnsAsync(dto);
        mediator.Setup(mock => mock.Send(It.IsAny<GetAllTypesQuery>(), It.IsAny<CancellationToken>())).ReturnsAsync(page);
        mediator.Setup(mock => mock.Send(It.IsAny<GetTypeQuery>(), It.IsAny<CancellationToken>())).ReturnsAsync(dto);
        mediator.Setup(mock => mock.Send(It.IsAny<GetTypeByNameQuery>(), It.IsAny<CancellationToken>())).ReturnsAsync(dto);
        mediator.Setup(mock => mock.Send(It.IsAny<GetTypeDetailsQuery>(), It.IsAny<CancellationToken>())).ReturnsAsync(details);
        mediator.Setup(mock => mock.Send(It.IsAny<GetTypeDetailsByNameQuery>(), It.IsAny<CancellationToken>())).ReturnsAsync(details);
        mediator.Setup(mock => mock.Send(It.IsAny<UpdateTypeCommand>(), It.IsAny<CancellationToken>())).ReturnsAsync(dto);
        var controller = new TypeController(mediator.Object);

        var created = Assert.IsType<CreatedAtActionResult>(await controller.Create(new CreateTypeCommand("Novel", null)));
        ...
        Assert.Same(dto, Assert.IsType<OkObjectResult>(await controller.Update(id, new UpdateTypeCommand { Name = "Manga" })).Value);
        Assert.IsType<NoContentResult>(await controller.Delete(id));
