...
export const books: Array<BookDto & BookListItemDto> = [
  {
    ...
    tagDescriptions: { favorite: 'A personal favorite.', mystery: 'Stories driven by secrets and investigation.' },
    tagsCount: 2,
    links: [],
    linksCount: 0,
  ...
  },
  {
    ...
    genreDescriptions: { 'Slice of Life': 'Everyday life and character-focused stories.' },
    genresCount: 1,
    tags: ['completed'],
    tagDescriptions: { completed: 'Finished reading.' },
    tagsCount: 1,
    links: [],
    linksCount: 0,
...
export const bookListItems: BookListItemDto[] = books.map((book) => ({
  ...
  authorOtherNames: book.authorOtherNames,
  ...
  genreDescriptions: book.genreDescriptions,
  genresCount: book.genres.length,
  tags: book.tags.slice(0, 4),
  tagDescriptions: book.tagDescriptions,
